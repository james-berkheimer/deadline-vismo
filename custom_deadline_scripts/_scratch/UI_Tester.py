...
def __main__():
    ...
    scriptDialog.SetTitle( "UI Tester" )
    
    scriptDialog.AddGrid()
    scriptDialog.AddControlToGrid( "Separator1", "SeparatorControl", "UI Testing", 0, 0, colSpan=2 )    
    ...
    scriptDialog.AddGroupBox("GroupBox1", "Test Group Box", True)
