...
def __main__( *args ):
    ...
    scriptDialog.SetTitle( "Submit modo Job To Deadline - VISMO_ModoSubmission_D10" )
...
###################################################
    ...
    scriptDialog.AddRangeControlToGrid( "ConcurrentTasksBox", "RangeControl", 3, 1, 16, 0, 1, 6, 1 )
...
##################################################################
    ...
    versionBox = scriptDialog.AddComboControlToGrid( "VersionBox", "ComboControl", "7xx", ( "3xx","4xx","5xx","6xx","7xx","8xx","9xx", "10xx", "11xx", "12xx", "13xx", "14xx" ), 6, 1 )
...
def SetVersionOutputFormats():
    ...
    formats["12xx"] = ( "$FLEX|flx|0|0=Flexible Precision FLX",
                    ...
                    "openexrlayers|exr|1|0=Layered OpenEXR 16-bit",
                    "openexrlayers32|exr|1|0=Layered OpenEXR 32-bit")
    formats["13xx"] = ( "$FLEX|flx|0|0=Flexible Precision FLX",
                    "$Targa|tga|1|1=Targa",
                    "BMP|BMP|1|1=Windows BMP",
                    "HDR|hdr|0|0=High Dynamic Range HDR",
                    "JPG|jpg|1|1=JPEG",
                    ...
                    "openexrlayers|exr|1|0=Layered OpenEXR 16-bit",
                    "openexrlayers32|exr|1|0=Layered OpenEXR 32-bit")
    formats["14xx"] = ( "$FLEX|flx|0|0=Flexible Precision FLX",
                    "$Targa|tga|1|1=Targa",
                    "BMP|BMP|1|1=Windows BMP",
                    "HDR|hdr|0|0=High Dynamic Range HDR",
                    "JPG|jpg|1|1=JPEG",
