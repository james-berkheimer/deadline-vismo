...
###################################################################################################################################
    ...
    scriptDialog.SetValue( "SceneBox", sceneFileFull )
    scriptDialog.SetValue( "FramesBox", frameRange )
    scriptDialog.SetValue( "OutputBox", outputPath )
    scriptDialog.SetValue( "FileTypeBox", fileTypeBox )
    scriptDialog.SetValue( "ProjectCodeBox", projectCode )
    scriptDialog.SetValue( "ProjectPhaseBox", projectPhase )
    scriptDialog.SetValue( "VersionBox", mayaVersion )    
    scriptDialog.SetValue( "FrameSizeBox", frameSize )    
    scriptDialog.SetValue( "ProjectBox", projectPath )
    cameras = cameraNamesString.split(",")
    scriptDialog.SetItems( "CameraBox", cameras )
    scriptDialog.SetValue( "CameraBox", cameras[0] )
    sceneName = Path.GetFileName( sceneFileFull )
    jobName = sceneName[:-3]
