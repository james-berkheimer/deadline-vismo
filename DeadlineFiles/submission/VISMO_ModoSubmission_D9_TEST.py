...
def __main__( *args ):
    ...
    scriptDialog.SetTitle( "Submit modo Job To Deadline - VISMO_ModoSubmission_D9" )
...
##################################################################
    ...
    scriptDialog.AddSelectionControlToGrid( "CloseOnSubmissionBox", "CheckBoxControl", True, "Close on Submission", 0, 0, "If checked, the submitter will close after job submission is completed." )
...
###################################################################################################################################  
    ...
    settings = ("PoolBox","GroupBox","PriorityBox","SubmitSceneBox","VersionBox","BuildBox","PrefixBox","ThreadsBox")
    ...
    # 
    #     
    #     scriptDialog.SetValue( "SceneBox", 'O:\\Users\\jBerkheimer\\Clients\\ModoTest\\Animation\\ModoTest_MODO\\ALPHA\\OBJTest_01\\OBJTest_01_v001_JB.lxo' )
    #     scriptDialog.SetValue( "FramesBox", '1-120' )
    #     scriptDialog.SetValue( "OutputBox", '10xx' )
    #     scriptDialog.SetValue( "PrefixBox", 'OBJTest' )
    #     scriptDialog.SetValue( "FormatBox", '1280x720' )
    ...
    scriptDialog.SetValue( "SceneBox", 'O:\\Users\\jBerkheimer\\Clients\\ModoTest\\Animation\\ModoTest_MODO\\ALPHA\\OBJTest_01\\OBJTest_01_v001_JB.lxo' )
    scriptDialog.SetValue( "FramesBox", '1-120' )
    scriptDialog.SetValue( "VersionBox", '10xx' )
    
    scriptDialog.SetValue( "ProjectCodeBox", 'OBJTest' )
    scriptDialog.SetValue( "ProjectPhaseBox", 'ALPHA' )
    scriptDialog.SetValue( "FrameSizeBox", '1280x720' )
    scriptDialog.SetValue( "FileTypeBox", 'PNG' )
    passGroups = ''.split(",")
    scriptDialog.SetItems( "PassBox", passGroups )
    scriptDialog.SetValue( "PassBox", passGroups[0] )
    
    
    sceneName = Path.GetFileName( 'O:\\Users\\jBerkheimer\\Clients\\ModoTest\\Animation\\ModoTest_MODO\\ALPHA\\OBJTest_01\\OBJTest_01_v001_JB.lxo' )
    jobName = sceneName[:-4]
    scriptDialog.SetValue( "NameBox", jobName )
    outputFileNamesFromScene = []
    outputFileNamesFromScene = 'O:\\Users\\jBerkheimer\\Clients\\ModoTest\\Animation\\frames\\MODO_OBJTest_ALPHA\\OBJTest_01\\OBJTest_01_v001\\COL\\Global_col\\OBJTest_01_v001_Global_col_,PNG'.split(",")
    
    vismoDraftTemplate = "//renderfarm/DeadlineRepository6/draft/VISMO/VISMO_encode_to_MP4_H264_720p.py"
    
    # Set Project Path
    scriptDialog.SetValue( "ProjectBox", 'O:\\Users\\jBerkheimer\\Clients\\ModoTest\\Animation' )
...
def SubmitButtonPressed( *args ):
    ...
    #     padding = GetPadding()
    #     outputFilename = Path.Combine( outputFolder, outputPrefix + padding + outputExtension )
