...
def __main__():
    ...
    print("OutputFileName: %s" % JobUtils.GetOutputFilename(0, 0))
    ...
    arguments = (outputFilenamesString, userInitials, pluginName, jobName,
                 QtDirectory, frameSize, projectPhase)
    ...
    if versionId != "":
        arguments = (outputFilenamesString, userInitials, pluginName, jobName,
                     QtDirectory, frameSize, projectPhase, "EnableShotgun")

    print "------ Now calling VISMO_QuicktimeSubmission.py ------"
