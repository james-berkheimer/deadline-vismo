...
###################################################
    ...
    scriptDialog.AddSelectionControlToGrid( "LocalRenderingBox", "CheckBoxControl", True, "Enable Local Rendering", 10, 1, "If enabled, the frames will be rendered locally, and then copied to their final network location." )
    ...
    scriptDialog.AddComboControlToGrid( "ArnoldVerboseBox", "ComboControl", "2", ("0","1","2"), 12, 1 )
