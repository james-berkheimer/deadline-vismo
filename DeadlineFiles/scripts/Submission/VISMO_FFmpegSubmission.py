...
def __main__(*args):
    ...
    scriptDialog.AddControlToGrid("InputLabel", "LabelControl", "Input File",1, 0, "The input file to process.", False)
    inputBox = scriptDialog.AddSelectionControlToGrid("InputBox","FileBrowserControl","","All Files (*)", 1,1)

    scriptDialog.AddSelectionControlToGrid(
        "InputReplacePaddingBox", "CheckBoxControl", True,
        "Replace Frame in Input File(s) With Padding (file%04d.ext)", 2, 1,
    ...
    scriptDialog.AddControlToGrid("OutputLabel", "LabelControl", "Output File", 3, 0, "The output file path.", False)
    scriptDialog.AddSelectionControlToGrid("OutputBox", "FileSaverControl", "", "All Files (*)", 3, 1)
    ...
    scriptDialog.AddControlToGrid("FormatLabel", "LabelControl", "Format", 5,0, "The video container to use. ", False)
    formatBox = scriptDialog.AddComboControlToGrid("vFormatBox","ComboControl", "MP4", ("MP4", "MKV"), 5, 1)
    formatBox.ValueModified.connect(SetOutput)

    scriptDialog.AddControlToGrid("CodecLabel", "LabelControl", "Codec", 6, 0, "The compression type to use. ", False)
    scriptDialog.AddComboControlToGrid("vCodecBox", "ComboControl", "H.264",("H.264", "H.265"), 6, 1)

    scriptDialog.AddControlToGrid("FrameRateLabel", "LabelControl", "Frame Rate", 7, 0, "The frame rate to use. ", False)
    scriptDialog.AddComboControlToGrid("vFrameRateBox", "ComboControl", "24", ("24", "30"), 7, 1)

    scriptDialog.AddControlToGrid(
        "CRFLabel", "LabelControl", "Constant Rate Factor", 8, 0,
        "The range of the CRF scale is 0-51, where 0 is lossless, 23 is the default, and 51 is worst quality possible. \n"
        "A lower value generally leads to higher quality, and a subjectively sane range is 17-28. \n"
        "Consider 17 or 18 to be visually lossless or nearly so; it should look the same or nearly the same as the input but it isn't technically lossless.",
        False)
    scriptDialog.AddRangeControlToGrid("CRFBox", "RangeControl", 23, 0, 51, 2, 1, 8, 1)

    scriptDialog.AddControlToGrid(
        "PresetLabel", "LabelControl", "Preset", 9, 0,
    ...
    scriptDialog.AddComboControlToGrid("vPresetBox", "ComboControl", "medium",
                                       ("ultrafast", "superfast", "veryfast", "faster", "fast", "medium","slow", "slower", "veryslow"), 9, 1)
...
def SubmitButtonPressed(*args):
    ...
    writer.WriteLine("StartFrame=%s" % startFrame)
