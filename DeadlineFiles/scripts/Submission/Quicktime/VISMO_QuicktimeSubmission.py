...
def __main__(*args):
    ...
    scriptDialog.SetIcon(
        Path.Combine(RepositoryUtils.GetRootDirectory(),
                     "plugins/Quicktime/Quicktime.ico"))
    ...
    scriptDialog.AddControlToGrid("PoolBox", "PoolComboControl",
                                  "push_priority", 1, 1)
    ...
    scriptDialog.AddControlToGrid("GroupBox", "GroupComboControl", "quicktime",
                                  3, 1)
    ...
    ###################################################
    scriptDialog.AddControlToGrid(
        "InputLabel", "LabelControl", "Input Images 01", 1, 0,
    ...
    ##
    scriptDialog.AddControlToGrid(
        "InputLabel", "LabelControl", "Input Images 02", 2, 0,
        "The frames you would like to generate the Quicktime from. If a sequence of frames exist in the same folder, Deadline will automatically collect the range of the frames and will set the Frame Range accordingly. ",
        False)
    inputBox = scriptDialog.AddSelectionControlToGrid("InputBox02","FileBrowserControl","","All Files (*)",2,1,colSpan=3)
    ##
    scriptDialog.AddControlToGrid(
        "InputLabel", "LabelControl", "Input Images 03", 3, 0,
        "The frames you would like to generate the Quicktime from. If a sequence of frames exist in the same folder, Deadline will automatically collect the range of the frames and will set the Frame Range accordingly. ",
        False)
    inputBox = scriptDialog.AddSelectionControlToGrid("InputBox03",
                                                      "FileBrowserControl",
                                                      "",
                                                      "All Files (*)",
                                                      3,
    ...
    ##
    scriptDialog.AddControlToGrid(
        "InputLabel", "LabelControl", "Input Images 04", 4, 0,
        "The frames you would like to generate the Quicktime from. If a sequence of frames exist in the same folder, Deadline will automatically collect the range of the frames and will set the Frame Range accordingly. ",
        False)
    inputBox = scriptDialog.AddSelectionControlToGrid("InputBox04",
                                                      "FileBrowserControl",
                                                      "",
                                                      "All Files (*)",
                                                      4,
    ...
    scriptDialog.AddControlToGrid(
        "OutputLabel", "LabelControl", "Output Movie File", 6, 0,
        "The name of the Quicktime to be generated. ", False)
    scriptDialog.AddSelectionControlToGrid("OutputBox01",
                                           "FileSaverControl",
                                           "",
                                           "All Files (*)",
                                           6,
    ...
    scriptDialog.AddControlToGrid("StartFrameLabel", "LabelControl",
                                  ...
                                  False)
    scriptDialog.AddRangeControlToGrid("StartFrameBox01", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 7, 1)
    scriptDialog.AddControlToGrid("EndFrameLabel", "LabelControl", "End Frame",
                                  7, 2,
                                  "The last frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("EndFrameBox01", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 7, 3)
    ###
    scriptDialog.AddControlToGrid(
        "OutputLabel", "LabelControl", "Output Movie File", 8, 0,
        "The name of the Quicktime to be generated. ", False)
    scriptDialog.AddSelectionControlToGrid("OutputBox02",
                                           "FileSaverControl",
                                           "",
                                           "All Files (*)",
                                           8,
    ...
    scriptDialog.AddControlToGrid("StartFrameLabel", "LabelControl",
                                  ...
                                  "The first frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("StartFrameBox02", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 9, 1)
    scriptDialog.AddControlToGrid("EndFrameLabel", "LabelControl", "End Frame",
                                  9, 2,
                                  "The last frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("EndFrameBox02", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 9, 3)
    ###
    scriptDialog.AddControlToGrid(
        "OutputLabel", "LabelControl", "Output Movie File", 10, 0,
        "The name of the Quicktime to be generated. ", False)
    scriptDialog.AddSelectionControlToGrid("OutputBox03",
                                           "FileSaverControl",
                                           "",
                                           "All Files (*)",
                                           10,
    ...
    scriptDialog.AddControlToGrid("StartFrameLabel", "LabelControl",
                                  ...
                                  "The first frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("StartFrameBox03", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 11, 1)
    scriptDialog.AddControlToGrid("EndFrameLabel", "LabelControl", "End Frame",
                                  11, 2,
                                  "The last frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("EndFrameBox03", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 11, 3)
    ###
    scriptDialog.AddControlToGrid(
        "OutputLabel", "LabelControl", "Output Movie File", 12, 0,
        "The name of the Quicktime to be generated. ", False)
    scriptDialog.AddSelectionControlToGrid("OutputBox04",
                                           "FileSaverControl",
                                           "",
                                           "All Files (*)",
                                           12,
    ...
    scriptDialog.AddControlToGrid("StartFrameLabel", "LabelControl",
                                  ...
                                  "The first frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("StartFrameBox04", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 13, 1)
    scriptDialog.AddControlToGrid("EndFrameLabel", "LabelControl", "End Frame",
                                  13, 2,
                                  "The last frame of the input sequence.",
                                  False)
    scriptDialog.AddRangeControlToGrid("EndFrameBox04", "RangeControl", 0,
                                       -1000000, 1000000, 0, 1, 13, 3)
    ###################################################
    scriptDialog.EndGrid()
    ...
    scriptDialog.AddControlToGrid(
        "CodecLabel", "LabelControl", "Codec", 3, 0,
    ...
    codecBox = scriptDialog.AddComboControlToGrid(
        ...
        ("3G", "AVI", "DV Stream", "FLC", "MPEG-4", "QuickTime Movie"), 3, 1)
    codecBox.ValueModified.connect(CodecChanged)
    scriptDialog.AddControlToGrid(
        "CDFLabel", "LabelControl", "Constant Rate Factor", 3, 2,
    ...
    scriptDialog.AddControlToGrid(
        "SettingsLabel", "LabelControl", "Settings File (Optional)", 5, 0,
    ...
    settings = ("CategoryBox", "PoolBox", "GroupBox", "PriorityBox",
                "LimitGroupBox", "OnJobCompleteBox", "MachineListBox",
                "SubmitSuspendedBox", "IsBlacklistBox", "FrameRateBox",
                "CodecBox", "SettingsBox")
...
def fileSeqInfo(filename, num):
    ...
    if paddingSize > 0:
        filename = FrameUtils.GetLowerFrameFilename(filename, initFrame,
                                                    paddingSize)
        ...
        startFrame = FrameUtils.GetLowerFrameRange(filename, initFrame,
                                                   paddingSize)
        endFrame = FrameUtils.GetUpperFrameRange(filename, initFrame,
                                                 paddingSize)
        ...
        if pluginName == "AfterEffects":
            ...
            outputPathFilename = Path.ChangeExtension(outputPathFilename,
                                                      GetExtension())
...
def InputImagesModified(*args):
    ...
    if not updatingOutputFile:
        ...
        try:
            ...
            if filename01 != "":
                startFrame, endFrame, outputPathFilename = fileSeqInfo(
                    filename01, 1)
                ...
                filename = Path.GetFileNameWithoutExtension(
                    outputPathFilename.split("\\")[-1]) + "_" + userInitials
            ...
            if fileExists:
                ...
                scriptDialog.SetValue("FileTypeBox",
                                      GetExtension()[1:].upper())
            ...
            if not startup:
                scriptDialog.ShowMessageBox(e.Message,
                                            "Error Parsing Input Images")
...
def SettingsButtonPressed(*args):
    ...
    codec = scriptDialog.GetValue("CodecBox")
    settingsFile = Path.Combine(ClientUtils.GetDeadlineTempPath(),
                                "temp_quicktime_export_settings.xml")

    qtGenerator = Path.Combine(ClientUtils.GetBinDirectory(),
                               "deadlinequicktimegenerator")
    process = ProcessUtils.SpawnProcess(
        qtGenerator,
        "-ExportSettings \"" + settingsFile + "\" \"" + codec + "\"",
    ...
    newSettingsFile = scriptDialog.ShowSaveFileBrowser(
        "quicktime_export_settings.xml", "All Files (*)")
...
def GetSupportedFormats():
    formats = (".3gp", ".3g2", ".aiff", ".aif", ".au", ".snd", ".avi", ".bmp",
               ".dv", ".swf", ".gif", ".jpg", ".pnt", ".mid", ".mp3", ".mpu",
               ".mpeg", ".mpg", ".mp4", ".m4a", ".pct", ".psd", ".png", ".qtz",
               ".qtif", ".qif", ".qti", ".sgi", ".smi", ".tga", ".tiff",
               ".tif", ".wav", ".wmv")
    return formats
...
def ConnectButtonPressed(*args):
    ...
    if usingShotgun:
        script = Path.Combine(RepositoryUtils.GetRootDirectory(),
                              "events/Shotgun/ShotgunUI.py")
        settingsName = GetShotgunSettingsFilename()
    else:
        script = Path.Combine(RepositoryUtils.GetRootDirectory(),
                              "submission/FTrack/Main/FTrackUI.py")
        settingsName = GetFTrackSettingsFilename()
    output = ClientUtils.ExecuteCommandAndGetOutput(
        ("-ExecuteScript", script, "QuicktimeMonitor", "selectversion"))
...
def updateDisplay():
    ...
    if scriptDialog.GetValue("IntegrationTypeBox") == "Shotgun":
        ...
        scriptDialog.SetValue("IntegrationVersionBox",
                              shotgunSettings.get('VersionName', ""))
        scriptDialog.SetValue("IntegrationDescriptionBox",
                              shotgunSettings.get('Description', ""))
    else:
        ...
        scriptDialog.SetValue("IntegrationEntityInfoBox", displayText)
        scriptDialog.SetValue("IntegrationVersionBox",
                              fTrackSettings.get('FT_AssetName', ""))
        scriptDialog.SetValue("IntegrationDescriptionBox",
                              fTrackSettings.get('FT_Description', ""))
...
def IntegrationTypeBoxChanged():
    ...
    shotgunEnabled = (scriptDialog.GetValue("IntegrationTypeBox") == "Shotgun"
                      ) and scriptDialog.GetValue("CreateVersionBox")
...
def GetShotgunSettingsFilename():
    return Path.Combine(GetDeadlineSettingsPath(),
                        "QuicktimeMonitorSettingsShotgun.ini")


def GetFTrackSettingsFilename():
    return Path.Combine(GetDeadlineSettingsPath(),
                        "QuicktimeMonitorSettingsFTrack.ini")
...
def SubmitShotgunChanged(*args):
    ...
    scriptDialog.SetEnabled("IntegrationUploadMovieBox", integrationEnabled
                            and shotgunEnabled)
    scriptDialog.SetEnabled("IntegrationUploadFilmStripBox", integrationEnabled
                            and shotgunEnabled)
...
def CreateJob(inputFile, outputFile, i):
    ...
    writer.WriteLine(
        "Frames=%s-%s" %
        (scriptDialog.GetValue(startFrame), scriptDialog.GetValue(endFrame)))
...
def SubmitButtonPressed(*args):
    ...
    if (not IsFormatSupported(inputFiles[0])):
        ...
        scriptPath = Path.Combine(
            ...
            "custom/scripts/Submission/Quicktime/VISMO_QuicktimeSubmission.py")
        result = scriptDialog.ShowMessageBox(
            "The input file " + inputFiles[0] +
            " is not a supported format. If this format is supported by Quicktime, you can add its file extension to "
            + scriptPath +
    ...
    if (not Directory.Exists(Path.GetDirectoryName(outputFiles[0]))):
        scriptDialog.ShowMessageBox(
            "Path for the output file " + outputFiles[0] + " does not exist.",
            "Error")
        return
    elif (PathUtils.IsPathLocal(outputFiles[0])):
        result = scriptDialog.ShowMessageBox(
            "The output file " + outputFiles[0] +
            " is local, are you sure you want to continue?", "Warning",
            ("Yes", "No"))
        if (result == "No"):
            return
