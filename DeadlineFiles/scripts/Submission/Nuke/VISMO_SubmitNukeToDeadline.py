...
class DeadlineDialog( nukescripts.PythonPanel ):
    ...
    def __init__( self, maximumPriority, pools, secondaryPools, groups ):
        ...
        width = 600
        height = 840 #Nuke v6 or earlier UI height
...
##########################################################################################
        ...
        self.concurrentTasks.setValue( 3 )
...
##################################################################
    ...
    VISMO_DeadlineGlobals.initConcurrentTasks = 3
    VISMO_DeadlineGlobals.initLimitConcurrentTasks = True
    VISMO_DeadlineGlobals.initMachineLimit = 20
    ...
    VISMO_DeadlineGlobals.initChooseGpu = 0
    ...
    VISMO_DeadlineGlobals.initSmartVectorOnly = False
        ...
        if os.path.isfile( configFile ):
            ...
            if config.has_section( "Sticky" ):
                ...
                if config.has_option( "Sticky", "ChooseGpu" ):
                    VISMO_DeadlineGlobals.initChooseGpu = config.getint( "Sticky", "ChooseGpu" )
                ...
                if config.has_option( "Sticky", "SmartVectorOnly" ):
                    VISMO_DeadlineGlobals.initSmartVectorOnly = config.get( "Sticky", "SmartVectorOnly" )    
    except:
    ...
    try:
                ...
                if "ChooseGpu" in root.knobs():
                    VISMO_DeadlineGlobals.initChooseGpu = int( ( root.knob( "ChooseGpu" ) ).value() )
                ...
                if "SmartVectorOnly" in root.knobs():
                    VISMO_DeadlineGlobals.initSmartVectorOnly = ( root.knob( "SmartVectorOnly" ) ).value()
...
##################################################################
    ...
    dialog.chooseGpu.setValue( VISMO_DeadlineGlobals.initChooseGpu )
    ...
    dialog.smartVectorOnly.setValue( VISMO_DeadlineGlobals.initSmartVectorOnly )
