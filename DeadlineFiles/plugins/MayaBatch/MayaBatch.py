...
class MayaBatchPlugin (DeadlinePlugin):
    ...
    def StartJob( self ):
        ...
        if self.EnablePathMapping and not self.DirmapPathMapping and os.path.splitext( sceneFilename )[1].lower() == ".ma":
            ...
            self.SceneFile = os.path.join( tempSceneDirectory, tempSceneFileName )
    ...
    def RenderTasks( self ):
        ...
        if self.ScriptJob:
            ...
            # If using dirmap for path mapping, need to load the scene now (it's not loaded via the command line in this case).
            # Only do this for the first task the slave has picked up for this job.
            if self.FirstTask and self.EnablePathMapping:
                ...
                if self.XGenPathMapping:
                    ...
                    if len( mappings ) > 0:
                        ...
                        scriptBuilder.AppendLine( 'mapXGen( $deadlineMappings );' )
                        scriptBuilder.AppendLine()
    ...
    def CreateDelayLoadSceneMelscript( self, scriptBuilder ):
        ...
        scriptBuilder.AppendLine( "remapFileTextures();" )
    ...
    def unlockRedshiftRenderSetupOverrides( self ):
        ...
        unlockOverrideString += 'python( "DeadlineMayaBatchFunctions.unlockRenderSetupOverrides(\'" + $renderSetupOverrides + "\' )" );'
