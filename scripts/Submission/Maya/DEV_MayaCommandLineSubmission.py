...
def __main__( *args ):
    ...
    scriptDialog.SetIcon( Path.Combine( RepositoryUtils.GetRootDirectory(), "plugins/MayaCmd/MayaCmd.ico" ) )
...
def GetSettingsFilename():
    ...
    return Path.Combine( GetDeadlineSettingsPath(), "MayaCmdSettings.ini" )
