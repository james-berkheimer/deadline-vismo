...
print "------------------------ In VISMO_SubmitNukeToDeadline.py ------------------------"
...
class DeadlineDialog( nukescripts.PythonPanel ):
    ...
    def __init__( self, maximumPriority, pools, secondaryPools, groups ):
        ...
        nukescripts.PythonPanel.__init__( self, "Submit To VISMO_Deadline 8", "com.thinkboxsoftware.software.deadlinedialog" )

        width = 605
        height = 780 #Nuke v6 or earlier UI height
...
def SubmitToDeadline( ):
    ...
    if noRoot:
        VISMO_DeadlineGlobals.initJobName = "Untitled"
    else:
...
##################################################################
    ...
    VISMO_DeadlineGlobals.initBatchMode = True
    ...
    VISMO_DeadlineGlobals.initRenderMode = "Use Scene Settings"
    VISMO_DeadlineGlobals.initPerformanceProfiler = False
    VISMO_DeadlineGlobals.initReloadPlugin = False
    VISMO_DeadlineGlobals.initPerformanceProfilerPath = ""
    VISMO_DeadlineGlobals.initPrecompFirst = False
    VISMO_DeadlineGlobals.initPrecompOnly = False
    VISMO_DeadlineGlobals.initExtraInfo0 = ""
    VISMO_DeadlineGlobals.initExtraInfo1 = ""
    VISMO_DeadlineGlobals.initExtraInfo2 = ""
    VISMO_DeadlineGlobals.initExtraInfo3 = ""
    VISMO_DeadlineGlobals.initExtraInfo4 = ""
    VISMO_DeadlineGlobals.initExtraInfo5 = ""
    VISMO_DeadlineGlobals.initExtraInfo6 = ""
    VISMO_DeadlineGlobals.initExtraInfo7 = ""
    VISMO_DeadlineGlobals.initExtraInfo8 = ""
    VISMO_DeadlineGlobals.initExtraInfo9 = ""
    ...
    VISMO_DeadlineGlobals.initDraftQuick = "Quick"
    VISMO_DeadlineGlobals.initDraftCodec = "mjpeg"
    VISMO_DeadlineGlobals.initDraftFormat = "JPEG (jpg)"
    VISMO_DeadlineGlobals.initDraftFrameRate = "24"
    VISMO_DeadlineGlobals.initDraftResolution = "Full"
    VISMO_DeadlineGlobals.initDraftQuality = 85
        ...
        if os.path.isfile( configFile ):
            ...
            if config.has_section( "Sticky" ):
                ...
                if config.has_option( "Sticky", "RenderMode" ):
                    VISMO_DeadlineGlobals.initRenderMode = config.get( "Sticky", "RenderMode" )
                ...
                if config.has_option( "Sticky", "ReloadPlugin" ):
                    VISMO_DeadlineGlobals.initReloadPlugin = config.getboolean( "Sticky", "ReloadPlugin" )
                ...
                if config.has_option( "Sticky", "PrecompFirst" ):
                    VISMO_DeadlineGlobals.initPrecompFirst = config.getboolean( "Sticky", "PrecompFirst")
                if config.has_option( "Sticky", "PrecompOnly" ):
                    VISMO_DeadlineGlobals.initPrecompOnly = config.get( "Sticky", "PrecompOnly" )    
                ...
                if config.has_option( "Sticky", "DraftQuick" ):
                    VISMO_DeadlineGlobals.initDraftQuick = config.get( "Sticky", "DraftQuick" )
                if config.has_option( "Sticky", "DraftCodec" ):
                    VISMO_DeadlineGlobals.initDraftCodec = config.get( "Sticky", "DraftCodec" )
                if config.has_option( "Sticky", "DraftFormat" ):
                    VISMO_DeadlineGlobals.initDraftFormat = config.get( "Sticky", "DraftFormat" )
                if config.has_option( "Sticky", "DraftFrameRate" ):
                    VISMO_DeadlineGlobals.initDraftFrameRate = config.get( "Sticky", "DraftFrameRate" )
                if config.has_option( "Sticky", "DraftResolution" ):
                    VISMO_DeadlineGlobals.initDraftResolution = config.get( "Sticky", "DraftResolution" )
                if config.has_option( "Sticky", "DraftQuality" ):
                    VISMO_DeadlineGlobals.initDraftQuality = config.getint( "Sticky", "DraftQuality" )
    ...
    try:
                ...
                if "DeadlineRenderMode" in root.knobs():
                    VISMO_DeadlineGlobals.initRenderMode = ( root.knob( "DeadlineRenderMode" ) ).getText()
                ...
                if "ReloadPlugin" in root.knobs():
                    VISMO_DeadlineGlobals.initReloadPlugin = StrToBool( ( root.knob( "ReloadPlugin" ) ).value() )
                ...
                if "PrecompFirst" in root.knobs():
                    VISMO_DeadlineGlobals.initPrecompFirst = ( root.knob( "PrecompFirst" ) ).value()
                    
                if "PrecompOnly" in root.knobs():
                    VISMO_DeadlineGlobals.initPrecompOnly = ( root.knob( "PrecompOnly" ) ).value()
                ...
                if "DraftQuick" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftQuick = ( root.knob( "DraftQuick" ) ).value()
                    
                if "DraftCodec" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftCodec = ( root.knob( "DraftCodec" ) ).value()
                    
                if "DraftFormat" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftFormat = ( root.knob( "DraftFormat" ) ).value()
                    
                if "DraftFrameRate" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftFrameRate = ( root.knob( "DraftFrameRate" ) ).value()
                    
                if "DraftResolution" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftResolution = ( root.knob( "DraftResolution" ) ).value()
                    
                if "DraftQuality" in root.knobs():
                    VISMO_DeadlineGlobals.initDraftQuality = int( ( root.knob( "DraftQuality" ) ).value() )
    ...
    extraInfo = [ "" ] * 10
    extraInfo[ 0 ] = VISMO_DeadlineGlobals.initExtraInfo0
    extraInfo[ 1 ] = VISMO_DeadlineGlobals.initExtraInfo1
    extraInfo[ 2 ] = VISMO_DeadlineGlobals.initExtraInfo2
    extraInfo[ 3 ] = VISMO_DeadlineGlobals.initExtraInfo3
    extraInfo[ 4 ] = VISMO_DeadlineGlobals.initExtraInfo4
    extraInfo[ 5 ] = VISMO_DeadlineGlobals.initExtraInfo5
    extraInfo[ 6 ] = VISMO_DeadlineGlobals.initExtraInfo6
    extraInfo[ 7 ] = VISMO_DeadlineGlobals.initExtraInfo7
    extraInfo[ 8 ] = VISMO_DeadlineGlobals.initExtraInfo8
    extraInfo[ 9 ] = VISMO_DeadlineGlobals.initExtraInfo9
...
##################################################################
    ...
    dialog.renderMode.setValue( VISMO_DeadlineGlobals.initRenderMode )
    dialog.performanceProfiler.setValue( VISMO_DeadlineGlobals.initPerformanceProfiler )
    dialog.reloadPlugin.setValue( VISMO_DeadlineGlobals.initReloadPlugin )
    dialog.performanceProfilerPath.setValue( VISMO_DeadlineGlobals.initPerformanceProfilerPath )
    dialog.precompFirst.setValue( VISMO_DeadlineGlobals.initPrecompFirst )
    dialog.precompOnly.setValue( VISMO_DeadlineGlobals.initPrecompOnly )
    ...
    dialog.useQuickDraft.setValue( VISMO_DeadlineGlobals.initDraftQuick )
    dialog.draftFormat.setValue( VISMO_DeadlineGlobals.initDraftFormat )
    dialog.AdjustCodecs()
    dialog.draftCodec.setValue( VISMO_DeadlineGlobals.initDraftCodec )
    dialog.AdjustFrameRates()
    dialog.draftFrameRate.setValue( VISMO_DeadlineGlobals.initDraftFrameRate )
    dialog.draftResolution.setValue( VISMO_DeadlineGlobals.initDraftResolution )
    dialog.AdjustQuality()
    dialog.draftQuality.setValue( VISMO_DeadlineGlobals.initDraftQuality )
