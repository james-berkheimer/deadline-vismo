...
def __main__():
    ...
    jobDirectory = os.path.dirname(outputFilename)
    ...
    arguments = (outputFilename, userInitials, pluginName, jobName, QtDirectory, frameSize, projectPhase)   
    
    # Making QT directories
    makeMovieDirectory(QtDirectory)
    
    print ("PROJECT PHASE IS.................." + projectPhase)
    
    versionId = job.GetJobExtraInfoKeyValue( "VersionId" )
    if versionId != "":
        arguments = (outputFilename, userInitials, pluginName, jobName, QtDirectory, frameSize, projectPhase, "EnableShotgun")
